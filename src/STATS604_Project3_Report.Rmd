...
## 5.5 Benjamini Hochberg for Multiple Tests

To determine significance, we run our Benjamini-Hochberg procedure to account for the fact that three different nulls were assessed. We have the following:

```{r}
p_values <- c(
  water_effect = 1.00e-04,      
  sunlight_effect = 1.32e-02,   
  dw_vs_fn = 2.00e-04          
)
...
The BH procedure confirmed our previous results.

## 5.6. Controlling Site-level environment
